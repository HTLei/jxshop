...
return [
    ...
    //发货状态
    //0-未发货 ， 1-已发货 ，2-已收货 ,3-退货中 4-退货成功
    'send_status'   => [
        0   => "<span style='color:red;'>未发货</span>",
        1   => "<span style='color:orange;'>已发货</span>",
        2   => "<span style='color:green;'>已收货</span>",
        3   => "<span style='color:grey;'>退货中</span>",
        4   => "<span style='color:darkslategray;'>退货成功</span>"
    ],

    //快递100接口密钥
    'kuaidi100_key' => '9d37bc6b0a41e6fe',
