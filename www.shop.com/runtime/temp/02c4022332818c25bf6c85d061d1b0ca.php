<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\item\www.shop.com\public/../application/home\view\goods\detail.html";i:1535792889;s:63:"D:\item\www.shop.com\application\home\view\public\head_nav.html";i:1535853400;}*/ ?>
...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_left fl">
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					<?php if(is_array($historyGoods) || $historyGoods instanceof \think\Collection || $historyGoods instanceof \think\Paginator): if( count($historyGoods)==0 ) : echo "" ;else: foreach($historyGoods as $key=>$v): ?>
					<dl>
				...
				<div class="preview fl">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php foreach($goods['goods_img'] as $k => $v):?>
								<li <?php echo $k == 0 ? 'class="cur"' : ''; ?>>
									<a <?php echo $k == 0 ? 'class="zoomThumbActive"' : ''; ?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo "/uploads/" . $goods['goods_middle'][$k]; ?>',largeimage: '<?php echo '/uploads/' . $v; ?>'}"><img src="<?php echo '/uploads/' . $goods['goods_thumb'][$k]; ?>"></a>
								</li>
								<?php endforeach; ?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="" method="post" class="choose">
						<ul>
							...
							<?php if(is_array($single_attrs) || $single_attrs instanceof \think\Collection || $single_attrs instanceof \think\Paginator): if( count($single_attrs)==0 ) : echo "" ;else: foreach($single_attrs as $key=>$v): ?>
							<li class="product">
								<dl>
									...
									<dd>
										...
										<a <?php if($key ==0): ?>class="selected"<?php else: ?>''<?php endif; ?> href="javascript:;"><?php echo $vv['attr_value']; ?>
											<input type="radio" name="" value="<?php echo $vv['goods_attr_id']; ?>" checked="checked" />
										</a>
										<?php endforeach; endif; else: echo "" ;endif; ?>
									</dd>
								</dl>
							...
							<li>
								<dl>
									<dt>&nbsp;</dt>
									<dd>
										<input type="button" goods_id="<?php echo $goods['goods_id']; ?>" value="" class="add_btn" />
									</dd>
								</dl>
							</li>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div ">
						<div class="attr mt15">
							<ul>
								<?php if(is_array($unique_attrs) || $unique_attrs instanceof \think\Collection || $unique_attrs instanceof \think\Paginator): if( count($unique_attrs)==0 ) : echo "" ;else: foreach($unique_attrs as $key=>$unique_attr): ?>
								<li><span><?php echo $unique_attr['attr_name']; ?>：</span><?php echo $unique_attr['attr_value']; ?></li>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>
	...
	<script type="text/javascript">
        ...
        $("input[class='add_btn']").click(function(){
            //商品id
            var goods_id = $(this).attr('goods_id');
            //商品数量
            var goods_number = $('.amount').val();
            //商品属性id
            var inputs = $('.selected > input');
            var goods_attr_ids = [];
            for(var i=0;i<inputs.length;i++){
                goods_attr_ids.push(inputs[i].value);
            }
            //把一个数组用','逗号拼接成字符串
            ...
            $.get("<?php echo url('/home/cart/addGoodsToCart'); ?>",param,function(res){
                ...
                if(res.code == 200){
                    layer.confirm(res.msg, {
                        ...
                        //点击去结算
                        location.assign("<?php echo url('/home/cart/cartList'); ?>");
                    }, function(){
                    ...
                    layer.confirm(res.msg, {
                        ...
                        //带商品id过去，目的是登录成功后直接跳转到该商品详情页
                        location.assign("<?php echo url('/home/public/login',['goods_id'=>$goods['goods_id']]); ?>");
                    }, function(){
