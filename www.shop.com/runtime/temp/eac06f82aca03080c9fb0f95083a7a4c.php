<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\item\www.shop.com\public/../application/home\view\order\orderInfo.html";i:1535794269;s:63:"D:\item\www.shop.com\application\home\view\public\head_nav.html";i:1535853400;}*/ ?>
...
<body>
	...
	<div class="fillin w990 bc mt15">
		...
		<div class="fillin_bd">
			...
			<div class="goods">
				...
				<table>
					...
					<tbody>
						<?php $totalPrice = 0; $totalNum = 0; foreach($cartData as $v): 
							$unitPrice = (float)$v['attr']['attrTotalPrice'] + (float)$v['goodsInfo']['goods_price'];
							$goods_number = $v['goods_number'];
							$subtotal = $unitPrice * $goods_number;
							$totalNum += $goods_number;
							$totalPrice += $subtotal;
						?>
						<tr>
							<td class="col1"><a href="<?php echo url('/home/goods/detail',['goods_id'=>$v['goods_id']]); ?>"><img src="/uploads/<?php echo json_decode($v['goodsInfo']['goods_middle'])[0]; ?>" alt="" /></a>  <strong><a href="<?php echo url('/home/goods/detail',['goods_id'=>$v['goods_id']]); ?>"><?php echo $v['goodsInfo']['goods_name']?></a></strong></td>
							<td class="col2"> <p><?php echo $v['attr']['attrInfo']; ?></p> </td>
							<td class="col3">￥<?php echo $unitPrice; ?></td>
							<td class="col4"> <?php echo $goods_number; ?></td>
		...
		<div class="fillin_ft">
			<a href="javascript:void(0);" id="commitOrder"><span
			4>提交订单</span></a>
