<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\item\www.shop.com\public/../application/admin\view\user\upd.html";i:1534937112;}*/ ?>
    ...
    <div class="formbody">
        ...
        <form action="" method="post">
            ...
            <ul class="forminfo">
                <li>
                    <label>用户名</label>
                    <input name="username" value="<?php echo $user['username']; ?>" readonly="readonly" placeholder="请输入用户名" type="text" class="dfinput" /><i></i>
                </li>
                <li>
                    <label>选择角色</label>
                ...
                <li>
                    <label>密码</label>
                    <input name="password" placeholder="请输入密码" type="password" class="dfinput" /><i>留空默认密码不修改</i>
                </li>
                <li>
                    <label>确认密码</label>
