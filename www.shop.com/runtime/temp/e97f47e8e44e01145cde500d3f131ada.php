<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\item\www.shop.com\public/../application/admin\view\type\index.html";i:1534949222;}*/ ?>
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($types) || $types instanceof \think\Collection || $types instanceof \think\Paginator): if( count($types)==0 ) : echo "" ;else: foreach($types as $key=>$type): ?>
                <tr>
                    ...
                    <td><?php echo $type['create_time']; ?></td>
                    <td><?php echo $type['update_time']; ?></td>
                    <td><a href="<?php echo url('/admin/type/getAttr',['type_id'=>$type['type_id']]); ?>" class="tablelink">查看属性</a> <a href="<?php echo url('/admin/type/upd',['type_id'=>$type['type_id']]); ?>" class="tablelink">编辑</a> <a href="<?php echo url('/admin/type/del',['type_id'=>$type['type_id']]); ?>" onclick="return confirm('确定要删除吗？');" class="tablelink"> 删除</a></td>
                </tr>
