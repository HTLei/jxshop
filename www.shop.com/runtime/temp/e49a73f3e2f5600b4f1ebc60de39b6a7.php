<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\item\www.shop.com\public/../application/home\view\category\index.html";i:1535598593;s:63:"D:\item\www.shop.com\application\home\view\public\head_nav.html";i:1535853400;}*/ ?>
...
<body>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="list_left fl mt10">
			<!-- 分类列表 start -->
			<div class="catlist">
				<h2><?php echo $cats[0]['cat_name']; ?>
				</h2>
				<div class="catlist_wrap">
					<?php foreach($children[$cats[0]['cat_id']] as $two): ?>
					<div class="child">
						<h3 class="on"><b></b><?php echo $categorys[$two]['cat_name'] ?></h3>
						<ul>
							<?php foreach($children[$two] as $three): ?>
							<li><a href="<?php echo url('/home/category/index',['cat_id'=>$categorys[$three]['cat_id']]); ?>"><?php echo $categorys[$three]['cat_name'] ?></a></li>
							<?php endforeach; ?>
						</ul>
					</div>
					<?php endforeach; ?>
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					...
					<dl class="last">
						<dt><a href=""><img src="<?php echo config('static_home'); ?>/images/crazy4.jpg" alt="" /></a></dt>
				...
				<ul>
					...
					<li>
						<dl>
							...
							<dd><strong>￥<?php echo $v['goods_price']; ?>.00</strong></dt>
