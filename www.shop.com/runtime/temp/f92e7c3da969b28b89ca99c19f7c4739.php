<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\item\www.shop.com\public/../application/home\view\public\login.html";i:1535598593;}*/ ?>
				...
				<form action="" method="post">
					<ul>
						...
						<li class="checkcode">
							...
							<img src="<?php echo captcha_src('2'); ?>" alt="" id="captcha" />
...
<script>
	function changeCaptcha(){
	    document.getElementById('captcha').setAttribute('src',"<?php echo captcha_src('2'); ?>?_=" + Math.random());
	}
	changeCaptcha();
</script>
</html>