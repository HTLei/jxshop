<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\item\www.shop.com\public/../application/home\view\index\index.html";i:1535598593;s:63:"D:\item\www.shop.com\application\home\view\public\head_nav.html";i:1535853400;}*/ ?>
...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="/"><img src="<?php echo config('static_home'); ?>/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd">
					...
					<div class="cat item1">
						<h3><a href="<?php echo url('/home/category/index',['cat_id'=>$cats[$one]['cat_id']]); ?>"><?php echo $cats[$one]['cat_name']; ?></a> <b></b></h3>
						<div class="cat_detail">
							...
							<dl class="dl_1st">
								<dt><a href="<?php echo url('/home/category/index',['cat_id'=>$cats[$two]['cat_id']]); ?>"><?php echo $cats[$two]['cat_name']; ?></a></dt>
								<dd>
									...
									<a href="<?php echo url('/home/category/index',['cat_id'=>$cats[$three]['cat_id']]); ?>"><?php echo $cats[$three]['cat_name']; ?></a>
			...
			<div class="navitems fl">
				<ul class="fl">
					...
					<li><a href="<?php echo url('/home/category/index',['cat_id'=>$navCat['cat_id']]); ?>"><?php echo $navCat['cat_name']; ?></a></li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<?php if(is_array($crazyGoods) || $crazyGoods instanceof \think\Collection || $crazyGoods instanceof \think\Paginator): if( count($crazyGoods)==0 ) : echo "" ;else: foreach($crazyGoods as $key=>$crazy): ?>
						<li>
							<dl>
								<dt><a href="<?php echo url('/home/goods/detail',['goods_id'=>$crazy['goods_id']]); ?>"><img src="/uploads/<?php echo json_decode($crazy['goods_middle'])[0]; ?>" alt="" /></a></dt>
				...
				<div class="hot none">
					<ul>
						<?php if(is_array($hotGoods) || $hotGoods instanceof \think\Collection || $hotGoods instanceof \think\Paginator): if( count($hotGoods)==0 ) : echo "" ;else: foreach($hotGoods as $key=>$hot): ?>
						<li>
							<dl>
								<dt><a href="<?php echo url('/home/goods/detail',['goods_id'=>$hot['goods_id']]); ?>"><img src="/uploads/<?php echo json_decode($hot['goods_middle'])[0]; ?>" alt="" /></a></dt>
				...
				<div class="recommend none">
					<ul>
						<?php if(is_array($bestGoods) || $bestGoods instanceof \think\Collection || $bestGoods instanceof \think\Paginator): if( count($bestGoods)==0 ) : echo "" ;else: foreach($bestGoods as $key=>$best): ?>
						<li>
							<dl>
								<dt><a href="<?php echo url('/home/goods/detail',['goods_id'=>$best['goods_id']]); ?>"><img src="/uploads/<?php echo json_decode($best['goods_middle'])[0]; ?>" alt="" /></a></dt>
				...
				<div class="new none">
					<ul>
						<?php if(is_array($newGoods) || $newGoods instanceof \think\Collection || $newGoods instanceof \think\Paginator): if( count($newGoods)==0 ) : echo "" ;else: foreach($newGoods as $key=>$new): ?>
						<li>
							<dl>
								<dt><a href="<?php echo url('/home/goods/detail',['goods_id'=>$new['goods_id']]); ?>"><img src="/uploads/<?php echo json_decode($new['goods_middle'])[0]; ?>" alt="" /></a></dt>
