<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\item\www.shop.com\public/../application/admin\view\public\login.html";i:1534574235;}*/ ?>
    ...
    <form action="" method="post">
        <div class="loginbody">
            ...
            <div class="loginbox">
                <ul>
                    <li>
                        <input name="username" type="text" class="loginuser" autofocus placeholder="用户名" />
                    </li>
                    <li>
