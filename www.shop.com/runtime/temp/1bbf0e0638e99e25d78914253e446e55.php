<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\item\www.shop.com\public/../application/admin\view\auth\index.html";i:1534678096;}*/ ?>
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($auths) || $auths instanceof \think\Collection || $auths instanceof \think\Paginator): if( count($auths)==0 ) : echo "" ;else: foreach($auths as $key=>$auth): ?>
                <tr>
                    ...
                    <td><?php echo str_repeat('--- ',$auth['level']); ?><?php echo $auth['auth_name']; ?></td>
                    <td><?php echo $auth['p_name']; ?></td>
                    <td><?php echo $auth['auth_c']; ?></td>
                    <td><?php echo $auth['auth_a']; ?></td>
                    <td><a href="<?php echo url('/admin/auth/upd',['auth_id'=>$auth['auth_id']]); ?>" class="tablelink">编辑</a> <a href="<?php echo url('/admin/auth/del',['auth_id'=>$auth['auth_id']]); ?>" onclick="return confirm('确定要删除吗？');" class="tablelink"> 删除</a></td>
                </tr>
