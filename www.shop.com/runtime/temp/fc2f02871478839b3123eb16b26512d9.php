<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\item\www.shop.com\public/../application/admin\view\type\add.html";i:1534757468;}*/ ?>
    ...
    <div class="formbody">
        ...
        <form action="" method="post">
            <ul class="forminfo">
                ...
                <li>
                    <label>备注</label>
                    <textarea name="mark" class="textinput"></textarea><i></i>
                </li>
            </ul>
			<li>
                    <label>&nbsp;</label>
